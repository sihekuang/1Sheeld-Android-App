...
public enum UIShield {
            ...
            R.drawable.shields_list_led_symbol, false, LedShield.class, LedFragment.class),

            NOTIFICATION_SHIELD(
            (byte) 0x06, "Notification", 0xffd4d903,
            R.drawable.shields_list_notifications_symbol, false,
            NotificationShield.class, NotificationFragment.class),

            SEVENSEGMENT_SHIELD((byte) 0x07,
            "Seven Segment", 0xffe28203,
            R.drawable.shields_list_seven_segment_symbol, false,
            SevenSegmentShield.class, SevenSegmentFragment.class),

            BUZZER_SHIELD((byte) 0x08, "Buzzer",
            0xffe93f03, R.drawable.shields_list_buzzer_symbol, false,
            SpeakerShield.class, BuzzerFragment.class),

            MIC_SHIELD((byte) 0x18, "Mic", 0xff0362c0,
            R.drawable.shields_list_mic_symbol, false, MicShield.class, MicFragment.class, 1),

            KEYPAD_SHIELD(
            (byte) 0x09, "Keypad", 0xff03c0ae,
            R.drawable.shields_list_keypad_symbol, false, KeypadShield.class, KeypadFragment.class),

            SLIDER_SHIELD(
            (byte) 0x01, "Slider", 0xffc0034c,
            R.drawable.shields_list_slider_symbol, false, SliderShield.class, SliderFragment.class),

            LCD_SHIELD(
            (byte) 0x17, "LCD", 0xff99bd03, R.drawable.shields_list_lcd_symbol,
            false, LcdShield.class, LcdFragment.class, true), MAGNETOMETER_SHIELD((byte) 0x0A,
            "Magnetometer", 0xff40039f,
            R.drawable.shields_list_magnetometer_symbol, false,
            MagnetometerShield.class, MagnetometerFragment.class, 1),

            PUSHBUTTON_SHIELD((byte) 0x03,
            "Push Button", 0xffb97547,
            R.drawable.shields_list_push_button_symbol, false,
            PushButtonShield.class, PushButtonFragment.class),

            TOGGLEBUTTON_SHIELD((byte) 0x04,
            "Toggle Button", 0xffc0039d,
            R.drawable.shields_list_push_button_symbol, false,
            ToggleButtonShield.class, ToggleButtonFragment.class),

            ACCELEROMETER_SHIELD((byte) 0x0B,
            "Accelerometer", 0xff266a5d,
            R.drawable.shields_list_accelerometer_symbol, false,
            AccelerometerShield.class, AccelerometerFragment.class, 1),

            FACEBOOK_SHIELD((byte) 0x19,
            "Facebook", 0xff039dc0, R.drawable.shields_list_facebook_symbol,
            false, FacebookShield.class, FacebookFragment.class),

            TWITTER_SHIELD((byte) 0x1A,
            "Twitter", 0xffa14c4c, R.drawable.shields_list_twitter_symbol,
            false, TwitterShield.class, TwitterFragment.class),

            GAMEDPAD_SHIELD((byte) 0x0C,
            "Game Pad", 0xff658f08, R.drawable.shields_list_gamepad_symbol,
            false, GamepadShield.class, GamepadFragment.class),

            FOURSQUARE_SHIELD((byte) 0x1B,
            "Foursquare", 0xff061179,
            R.drawable.shields_list_foursquare_symbol, false,
            FoursquareShield.class, FoursquareFragment.class),

            GPS_SHIELD((byte) 0x1C, "GPS", 0xffa10b07,
            R.drawable.shields_list_gps_symbol, false, GpsShield.class, GpsFragment.class),

            SMS_SHIELD(
            (byte) 0x0D, "SMS", 0xffdb7f40, R.drawable.shields_list_sms_symbol,
            false, SmsShield.class, SmsFragment.class, 1),

            MUSICPLAYER_SHIELD((byte) 0x1D,
            "Music Player", 0xffb950e9,
            R.drawable.shields_list_musicplayer_symbol, false,
            MusicShield.class, MusicPlayerFragment.class),

            GYROSCOPE_SHIELD((byte) 0x0E, "Gyroscope",
            0xff4c84e9, R.drawable.shields_list_gyroscope_symbol, false,
            GyroscopeShield.class, GyroscopeFragment.class, 1),

            SKYPE_SHIELD((byte) 0x1F, "Skype",
            0xff08c473, R.drawable.shields_list_skype_symbol, false,
            SkypeShield.class, SkypeFragment.class),

            PROXIMITY_SHIELD((byte) 0x13, "Proximity",
            0xff543c8d, R.drawable.shields_list_proximity_symbol, false,
            ProximityShield.class, ProximityFragment.class, 1),

            GRAVITY_SHIELD((byte) 0x14, "Gravity",
            0xffd95342, R.drawable.shields_list_gravity_symbol, false,
            GravityShield.class, GravityFragment.class, 1),

            ORIENTATION_SHIELD((byte) 0x0F,
            "Orientation", 0xff58844f,
            R.drawable.shields_list_orientation_symbol, false,
            OrientationShield.class, OrientationFragment.class, 1),

            LIGHT_SHIELD((byte) 0x10, "Light",
            0xff8b268d, R.drawable.shields_list_light_sensor_symbol, false,
            LightShield.class, LightFragment.class, 1),

            PRESSURE_SHIELD((byte) 0x11, "Pressure",
            0xff67584d, R.drawable.shields_list_pressure_symbol, false,
            PressureShield.class, PressureFragment.class, 1),

            TEMPERATURE_SHIELD((byte) 0x12,
            "Temperature", 0xff999f45,
            R.drawable.shields_list_temperature_symbol, false,
            TemperatureShield.class, TemperatureFragment.class, 1),

            CAMERA_SHIELD((byte) 0x15, "Camera",
            ...
            PhoneShield.class, PhoneFragment.class, 1),
            ...
            R.drawable.shields_list_gsm_symbol, false, EmptyShield.class, EmptyShieldFragment.class, false),

            GLCD(
            (byte) 0x20, "GLCD", 0xff988564,
            R.drawable.shields_list_lcd_symbol, false, EmptyShield.class, EmptyShieldFragment.class, false),

            EMAIL_SHIELD(
            (byte) 0x1E, "Email", 0xff114540,
            R.drawable.shields_list_email_symbol, false, EmailShield.class, EmailFragment.class),

            CLOCK_SHIELD(
            (byte) 0x21, "Clock", 0xffc45527,
            R.drawable.shields_list_clock_symbol, false, ClockShield.class, ClockFragment.class),

            KEYBOARD_SHIELD(
            (byte) 0x22, "Keyboard", 0xffde1f26,
            R.drawable.shields_list_keyboard_symbol, false,
            KeyboardShield.class, KeyboardFragment.class), TEXT_TO_SPEECH_SHIELD((byte) 0x23,
            "Text To Speech", 0xffde1f26, R.drawable.shields_list_tts_symbol,
            false, TextToSpeechShield.class, TextToSpeechFragment.class),

            SPEECH_RECOGNIZER_SHIELD(
            (byte) 0x24, "Voice Recognizer", 0xffde1f26,
            R.drawable.shields_list_voice_recognition_symbol, false,
            SpeechRecognitionShield.class, SpeechRecognitionFragment.class, 1),

            DATA_LOGGER((byte) 0x25,
            "Data Logger", 0xffde1f26,
            R.drawable.shields_list_data_logger_symbol, false,
            DataLoggerShield.class, DataLoggerFragment.class),

            TERMINAL_SHIELD((byte) 0x26, "Terminal",
            0xffde1f26, R.drawable.shields_list_terminal_symbol, false,
            TerminalShield.class, TerminalFragment.class),

            TASKER_SHIELD((byte) 0x0, "Tasker",
            0xff0b4c8d, R.drawable.shields_list_flashlight_symbol, false,
            TaskerShield.class, EmptyShieldFragment.class, false),

            PATTERN_SHIELD((byte) 0x27, "Pattern",
            0xffde1f26, R.drawable.shields_list_pattern_symbol, false,
            PatternShield.class, PatternFragment.class),

            INTERNET_SHIELD((byte) 0x29, "Internet",
            0xffde1f26, R.drawable.shields_list_internet_symbol, false,
            InternetShield.class, InternetFragment.class),

            NFC_SHIELD((byte) 0x16, "NFC", 0xff03d203,
